...
import os
"""['openDataPortal.siteAnalytics.downloads-102022-102023.csv', 'openDataPortal.siteAnalytics.info-102022-102023.csv', 
 'openDataPortal.siteAnalytics.visits-102022-102023.csv', 'opendataportal.siteanalytics.datasetsbyorg.bilingual.csv', 
 'opendataportal.siteanalytics.datasetsbyorgbymonth.bilingual.csv', 'opendataportal.siteanalytics.internationalusagebreakdown.bilingual102023.csv',
   'opendataportal.siteanalytics.provincialusagebreakdown.bilingual102023.csv', 'opendataportal.siteanalytics.top100datasets.bilingual.csv', 
   'opendataportal.siteanalytics.top20info.csv', 'opendataportal.siteanalytics.totalmonthlyusage.bilingual.csv'] 
 """
def resources_update():
 ...
 # Analytics resources
    resource_ids =["4ebc050f-6c3c-4dfd-817e-875b2caf3ec6", "b1dfa726-7ed1-4a6b-ae49-77a200abee72", "c14ba36b-0af5-4c59-a5fd-26ca6a1ef6db", 
                   "5a1b343d-2fea-4c31-8652-f77506e3ea37","f09148f9-a09b-46ec-bf5b-52f26720f3f3", "b52ee0b2-f2be-4bc5-a27a-db93a228d38b",
