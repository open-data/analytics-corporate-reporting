...
df.rename(columns={"ati_all":"ATI","contracts":"Contracts", "grants": "Grants", "travelq":"Travel", "hospitalityq":"Hospitality"}, inplace=True)
base_val =[("ATI",165646),("Contracts",1036237),("Grants",949177),("Travel",91093),("Hospitality",22449)]
