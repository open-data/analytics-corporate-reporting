# -*- coding: utf-8 -*-
"""res-views-validations.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1002QKzTMdqfU60bqZF8OcqAibMN4o31H
"""
...
def update_readme_section(readme_path, section_content, header, start_marker, end_marker):
    ...
    if start_marker in content and end_marker in content:
        ...
        # Ensure the header is present even if it wasn't before the marker in existing content
...
def build_dictionary_radar_chart(df):
    ...
    def percent_counts(subset):
        # Filter out NaN or zero ds_count to avoid division by zero or misleading percentages
...
with open(file_jsonl, "r", encoding="utf-8") as f:
    for line in f:
        ...
        package_id_main = tmp_data.get("id") # For package_lookup
        dataset_name_main = tmp_data.get("title") # For package_lookup
        owner_main = tmp_data.get("organization", {}).get("name") # For package_lookup
        ...
        for resource in tmp_res:
            ...
            # For package_lookup (build resource names dict)
...
# Update df_resource_views using local package_lookup for NaN owners
...
columns_to_keep_relations=['package_id','id','resource_type','name_translated_en','name_translated_fr','rel_resource_type','related_relationship','related_url_en', 'related_url_fr']
...
columns_to_keep_validation = ['format', 'resource_type', 'validation_status', 'validation_timestamp', 'id', 'package_id']
...
```
"""
with open("resource_validation_status_pie_chart.md", "w") as f:
...
# Update README with 'Resource Validation Status' chart
update_readme_section(
    readme_path,
...
```
"""
with open("resource_relation_type_pie_chart.md", "w") as f:
...
# Update README with 'Resource Relation Type' chart
update_readme_section(
    readme_path,
...
# --- 8. Process Datastore Information and Tracker ---
print("Processing datastore information...")
...
print("DS_num_tracker.csv updated.")
...
print("ds-resources.csv and ds-dictionary-use.csv saved.")

# --- 9. Generate Organizational Statistics ---
print("Generating organizational statistics...")
...
display(df_resource_views.head())
print("\ndf_relations_values.head():")
display(df_relations_values.head())
print("\ndf_validation_values.head():")
display(df_validation_values.head())
print("\nDS_num_tracker_df.head():")
display(DS_num_tracker_df.head())
print("\norg_stats.head():")
display(org_stats.head())