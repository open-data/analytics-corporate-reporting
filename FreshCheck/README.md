...
Generated at: `2026-08-09T02:27:33+00:00`
As of date: `2026-08-09`
Packages assessed: `47713`
Resources assessed: `243329`

### Split JSON Outputs
| File | Group | Jurisdiction values | Packages | Resources |
| --- | --- | --- | --- | --- |
| freshness_tree_federal.json | Federal | federal | 35776 | 163924 |
...
pie showData title Package timing against expected update date
    ...
    "Late 1-7 days": 104
    "Due in 0-7 days": 157
    "Due in 8-30 days": 419
    "Current > 30 days": 4477
    "Unknown": 37733
```
...
xychart-beta
    ...
    bar [77, 67, 61, 60, 57, 54, 44, 43, 43, 40, 40, 35, 29, 28, 26]
```
