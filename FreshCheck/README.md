...
Generated at: `2026-08-27T09:38:48+00:00`
As of date: `2026-08-27`
Packages assessed: `47808`
Resources assessed: `241934`

### Split JSON Outputs
| File | Group | Jurisdiction values | Packages | Resources |
| --- | --- | --- | --- | --- |
| freshness_tree_federal.json | Federal | federal | 35862 | 164504 |
| freshness_tree_provincial.json | Provincial | provincial | 11661 | 75780 |
...
pie showData title Package timing against expected update date
    "Late > 1 year": 3363
    "Late 91-365 days": 970
    "Late 31-90 days": 433
    "Late 8-30 days": 61
    "Late 1-7 days": 107
    "Due in 0-7 days": 188
    "Due in 8-30 days": 550
    "Current > 30 days": 4317
    "Unknown": 37819
```
...
xychart-beta
    ...
    x-axis ["chrc-ccdp", "csps-efpc", "fintrac-canafe", "apa", "pei-ipe", "pwgsc-tpsgc", "ns-ne", "on", "tf", "ccohs-cchst", "bc-cb", "cer-rec", "cmc-mcc", "ab", "ic"]
    y-axis "Current packages (%)" 0 --> 100
    bar [77, 67, 61, 60, 57, 55, 43, 43, 43, 40, 35, 31, 30, 28, 28]
```
